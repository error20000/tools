...
public class AutoCreate {
	...
	public AutoCreate(String packge, String dbPath){
	...
	public AutoCreate(String packge, String dbPath, String prefix, String separator){
		if(!Tools.isNullOrEmpty(packge)){
			config = new Config(packge);
		}
		if(!Tools.isNullOrEmpty(dbPath)){
...
//		test.start();
		...
		String prefix = "s_";
		String separator = "_";
		AutoCreate test =  new AutoCreate(new Config("com.testAuto"), new ConfigDB(jdbcUrl, user, password, driverClass, prefix, separator));
		test.start();
	}
